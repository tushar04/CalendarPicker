...
export default function Day(props) {
  ...
  let containerBgForSelectedRange;
  ...
  if (
    ...
    if (allowRangeSelection) {
      if (selectedStartDate && selectedEndDate) {
        ...
        //Changes by Tushar
        // Apply background color for days inside of range, excluding start & end dates.
        if (
          isThisDaySameAsSelectedStart ||
          isThisDaySameAsSelectedEnd ||
          thisDay.isBetween(selectedStartDate, selectedEndDate, "day", "()")
        ) {
          let cornerRadius = styles.endDayWrapper.borderRadius;
          containerBgForSelectedRange = [
            selectedRangeStyle,
            isThisDaySameAsSelectedEnd && {
